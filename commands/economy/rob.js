...
module.exports = {
    ...
    async execute(interaction, client) {
        ...
        if (money == 35 && moneysnd < 20) {
            ...
            return interaction.message.edit({ embeds: [notenoughmoney1.toJSON()], ephemeral: true })
     	};
        ...
        if (money == 35 && moneytar < 20) {
            console.log('[0xBOT] [i] [' + new Date().toLocaleTimeString('en-US', { hour12: false }) + '] [' + interaction.user.id.replace(/\D/g, '') + ' @ ' + interaction.guild.id + '] [CMD] ROB : ' + user + ' : NOTENOUGHMONEY')
            return interaction.message.edit({ embeds: [notenoughmoney2.toJSON()], ephemeral: true })
     	};
        ...
        if (status == false) {
        	...
        	return interaction.message.edit({ embeds: [failure.toJSON()] })
        }
        ...
        return interaction.message.edit({ embeds: [sucess.toJSON()] })
    },
};