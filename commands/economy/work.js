...
module.exports = {
    ...
    async execute(interaction) {
        ...
        if (cooldown.get(interaction.user.id) - Date.now() > 0) {
            ...
            // Send Message
            console.log('[0xBOT] [i] [' + new Date().toLocaleTimeString() + '] [' + interaction.user.id + ' @ ' + interaction.guild.id + '] WORK : ONCOOLDOWN : ' + cdown.toFixed(0) + use);
            ...
            console.log('[0xBOT] [i] [' + new Date().toLocaleTimeString() + '] [' + interaction.user.id + ' @ ' + interaction.guild.id + '] WORK : ' + result + '€');
