...
module.exports = {
    ...
    async execute(interaction, client, lang, vote) {
        ...
        if (userinfo.bot == true) {
            ...
            // Send Message
            bot.log(false, interaction.user.id, interaction.guild.id, '[CMD] MEMORY : ' + user.toString().replace(/\D/g, '') + ' : BOT')
            return interaction.reply({ embeds: [message.toJSON()], ephemeral: true })
        }
        ...
        if (lobby) {
            ...
            // Send Message
            bot.log(false, interaction.user.id, interaction.guild.id, '[CMD] MEMORY : ' + user.toString().replace(/\D/g, '') + ' : ALREADYLOBBY')
            return interaction.reply({ embeds: [message.toJSON()], ephemeral: true })
        }
        ...
        if (bet < 0 && bet != null) {
            ...
            // Send Message
            bot.log(false, interaction.user.id, interaction.guild.id, '[CMD] MEMORY : ' + user.toString().replace(/\D/g, '') + ' : NEGATIVEMONEY : ' + bet + '€')
            return interaction.reply({ embeds: [message.toJSON()], ephemeral: true })
        }
        ...
        if (interaction.user.id == user.toString().replace(/\D/g, '')) {
            ...
            // Send Message
            bot.log(false, interaction.user.id, interaction.guild.id, '[CMD] MEMORY : ' + user.toString().replace(/\D/g, '') + ' : ' + bet + '€ : SAMEPERSON')
            return interaction.reply({ embeds: [message.toJSON()], ephemeral: true })
        }
        ...
        if (money < bet && bet != null) {
            ...
            // Send Message
            bot.log(false, interaction.user.id, interaction.guild.id, '[CMD] MEMORY : ' + user.toString().replace(/\D/g, '') + ' : NOTENOUGHMONEY')
            return interaction.reply({ embeds: [message.toJSON()], ephemeral: true })
        }
        ...
        // Send Message
        bot.log(false, interaction.user.id, interaction.guild.id, '[CMD] MEMORY : ' + user.toString().replace(/\D/g, '') + ' : ' + bet + '€')
        ...
        const expiration = async () => {
            ...
            bot.log(false, interaction.user.id, interaction.guild.id, '[CMD] MEMORY : ' + user.toString().replace(/\D/g, '') + ' : EXPIRED')
