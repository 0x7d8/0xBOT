...
module.exports = {
    ...
    async execute(interaction) {
        ...
        if (cooldown.get(interaction.user.id) - Date.now() > 0) {
            ...
            // Send Message
            console.log('[0xBOT] [i] [' + new Date().toLocaleTimeString() + '] [' + interaction.user.id + ' @ ' + interaction.guild.id + '] QUOTE : ONCOOLDOWN : ' + cdown.toFixed(0) + 's');
        ...
        if (autor == null) {
            ...
            console.log('[0xBOT] [i] [' + new Date().toLocaleTimeString() + '] [' + interaction.user.id + ' @ ' + interaction.guild.id + '] QUOTE : ' + zitat.toUpperCase())
        } else {
            ...
            console.log('[0xBOT] [i] [' + new Date().toLocaleTimeString() + '] [' + interaction.user.id + ' @ ' + interaction.guild.id + '] QUOTE : ' + zitat.toUpperCase() + ' : ~' + autor)
            quts.add('<@' + autor + '>', 1);
        }
        ...
        if (userinfo.bot == true) {
            ...
            // Send Message
            console.log('[0xBOT] [i] [' + new Date().toLocaleTimeString() + '] [' + interaction.user.id + ' @ ' + interaction.guild.id + '] QUOTE : ' + user + ' : BOT : ' + zitat.toUpperCase())
            return interaction.reply({ embeds: [err.toJSON()], ephemeral: true })
        }
