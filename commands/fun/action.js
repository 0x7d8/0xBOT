...
module.exports = {
    ...
    async execute(interaction, client, lang, vote) {
        ...
        // Create Embeds
        const box = new EmbedBuilder().setColor('#37009B')
        ...
        const kill = new EmbedBuilder().setColor('#37009B')
        	.setTitle('<:BURST:1024393250611671170> » ACTION!')
        	...
        	.setFooter({ text: '» ' + vote + ' » ' + version });
        const stare = new EmbedBuilder().setColor('#37009B')
        	.setTitle('<:BURST:1024393250611671170> » ACTION!')
        	...
        	.setFooter({ text: '» ' + vote + ' » ' + version });
        const twerk = new EmbedBuilder().setColor('#37009B')
        	.setTitle('<:BURST:1024393250611671170> » ACTION!')
        	...
        	.setFooter({ text: '» ' + vote + ' » ' + version });
        const catchp = new EmbedBuilder().setColor('#37009B')
        	.setTitle('<:BURST:1024393250611671170> » ACTION!')
        	...
        	.setFooter({ text: '» ' + vote + ' » ' + version });
        const call = new EmbedBuilder().setColor('#37009B')
        	.setTitle('<:BURST:1024393250611671170> » ACTION!')
        	...
        	.setFooter({ text: '» ' + vote + ' » ' + version });
        const err = new EmbedBuilder().setColor('#37009B')
        	.setTitle('<:BURST:1024393250611671170> » ACTION?')
