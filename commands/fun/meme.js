...
module.exports = {
    ...
    async execute(interaction) {
        ...
        // Send Message
        console.log('[0xBOT] [i] [' + new Date().toLocaleTimeString('en-US', { hour12: false }) + '] [' + interaction.user.id.replace(/\D/g, '') + ' @ ' + interaction.guild.id + '] MEME : ' + subreddit.toUpperCase() + ' : ' + upvotes + '^ : ' + comments)
