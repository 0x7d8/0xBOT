...
module.exports = {
    ...
    async execute(interaction) {
        ...
        if (fs.existsSync(path)) {
        	...
        	// Send Message
        	console.log('[0xBOT] [i] [' + new Date().toLocaleTimeString() + '] [' + interaction.user.id + ' @ ' + interaction.guild.id + '] APIEDIT : ' + name + ' : ' + inhalt.toUpperCase())
            ...
            // Send Message
            console.log('[0xBOT] [i] [' + new Date().toLocaleTimeString() + '] [' + interaction.user.id + ' @ ' + interaction.guild.id + '] APIEDIT : ' + name + ' : NOTFOUND')
