...
module.exports = {
    ...
    async execute(interaction) {
        ...
        try {
        	...
        	// Send Message
        	console.log('[0xBOT] [i] [' + new Date().toLocaleTimeString() + '] [' + interaction.user.id + ' @ ' + interaction.guild.id + '] APIVIEW : ' + name + ' : ' + data.toUpperCase())
            ...
            // Send Message
            console.log('[0xBOT] [i] [' + new Date().toLocaleTimeString() + '] [' + interaction.user.id + ' @ ' + interaction.guild.id + '] APIVIEW : ' + name + ' : NOTFOUND')
