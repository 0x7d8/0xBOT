...
_c = "commands";
return [4, ctr.bot.stat.get("g-".concat(ctr.query.get('id')), 'cmd')];
case 2:
_f[_c] = _g.sent();
_d = "buttons";
return [4, ctr.bot.stat.get("g-".concat(ctr.query.get('id')), 'btn')];
case 3:
_f[_d] = _g.sent();
_e = "modals";
return [4, ctr.bot.stat.get("g-".concat(ctr.query.get('id')), 'mod')];
case 4: return [2, _b.apply(_a, [(_f[_e] = _g.sent(),
_f)])];
}
});
});
