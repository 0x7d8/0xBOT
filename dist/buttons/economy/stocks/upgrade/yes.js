...
execute: function (ctx, stock, userid, amount) {
return __awaiter(this, void 0, void 0, function () {
var message, balance, baseCost, cost, type, missing, message_1, emoji, message;
...
ctx.log(false, "[BTN] STOCKUPGRADE : ".concat(stock.toUpperCase(), " : NOTENOUGHMONEY : ").concat(cost, "\u20AC"));
...
.setDescription("\u00BB You successfully bought **".concat(amount, "x** ").concat(emoji, " Slots for **$").concat(cost, "**!"))
.setFooter({ text: '» ' + ctx.metadata.vote.text + ' » ' + ctx.client.config.version });
if (ctx.metadata.language == 'de') {
message = new discord_js_1.EmbedBuilder().setColor(0x37009B)
.setTitle('<:BOXCHECK:1024401101589590156> » AKTIEN SLOTS KAUFEN')
.setDescription("\u00BB Du hast erfolgreich **".concat(amount, "x** ").concat(emoji, " Slots f\u00FCr **").concat(cost, "\u20AC** gekauft!"))
.setFooter({ text: '» ' + ctx.metadata.vote.text + ' » ' + ctx.client.config.version });
}
...
ctx.log(false, "[BTN] STOCKUPGRADE : ".concat(amount, "x : ").concat(stock.toUpperCase(), " : CONFIRM"));
