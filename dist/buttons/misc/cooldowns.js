...
execute: function (ctx, userId, userName) {
return __awaiter(this, void 0, void 0, function () {
var ms, userobj, embedDesc, rawvalues, _a, _b, element, message;
var e_1, _c;
...
ctx.log(false, "[BTN] COOLDOWNS : ".concat(userId));
}
embedDesc = '';
return [4, ctx.db.query("select name, expires from usercooldowns where userid = $1 and expires / 1000 > extract(epoch from now());", [userobj.id])];
case 2:
rawvalues = _d.sent();
try {
for (_a = __values(rawvalues.rows), _b = _a.next(); !_b.done; _b = _a.next()) {
element = _b.value;
embedDesc += "\u00BB ".concat(element.name.toUpperCase(), "\n**").concat(ms((Number(element.expires) - Date.now()), { secondsDecimalDigits: 0 }), "**\n");
}
}
