...
ctx.interaction.message.components[comp[1]].components[comp[0]].data.emoji = ctx.bot.memory.get('D_EMOJI-' + sel + '-' + sender);
}
...
ctx.bot.memory.set('STYLE-' + ctx.bot.memory.get('B_PLAYERSELECT-' + ctx.interaction.user.id)[0] + '-' + sender, discord_js_1.ButtonStyle.Primary);
ctx.interaction.message.components[comp1[1]].components[comp1[0]].data.style = discord_js_1.ButtonStyle.Primary;
ctx.bot.memory.set('STYLE-' + ctx.bot.memory.get('B_PLAYERSELECT-' + ctx.interaction.user.id)[1] + '-' + sender, discord_js_1.ButtonStyle.Primary);
ctx.interaction.message.components[comp2[1]].components[comp2[0]].data.style = discord_js_1.ButtonStyle.Primary;
}
if (ctx.interaction.user.id == reciever) {
ctx.bot.memory.set('STYLE-' + ctx.bot.memory.get('B_PLAYERSELECT-' + ctx.interaction.user.id)[0] + '-' + sender, discord_js_1.ButtonStyle.Danger);
ctx.interaction.message.components[comp1[1]].components[comp1[0]].data.style = discord_js_1.ButtonStyle.Danger;
ctx.bot.memory.set('STYLE-' + ctx.bot.memory.get('B_PLAYERSELECT-' + ctx.interaction.user.id)[1] + '-' + sender, discord_js_1.ButtonStyle.Danger);
ctx.interaction.message.components[comp2[1]].components[comp2[0]].data.style = discord_js_1.ButtonStyle.Danger;
}
...
const comp2 = rowGet(ctx.bot.memory.get('B_PLAYERSELECT-' + ctx.interaction.user.id)[1]);
{
ctx.interaction.message.components[comp1[1]].components[comp1[0]].data.disabled = false;
ctx.interaction.message.components[comp1[1]].components[comp1[0]].data.emoji = { id: '1020411843644243998', name: 'MEMORY' };
ctx.interaction.message.components[comp2[1]].components[comp2[0]].data.disabled = false;
ctx.interaction.message.components[comp2[1]].components[comp2[0]].data.emoji = { id: '1020411843644243998', name: 'MEMORY' };
}
...
button.data.emoji = ctx.bot.memory.get('D_EMOJI-' + (i + 1) + '-' + sender);
button.data.style = ctx.bot.memory.get('STYLE-' + (i + 1) + '-' + sender);
...
button.data.emoji = ctx.bot.memory.get('D_EMOJI-' + (i + 1) + '-' + sender);
button.data.style = ctx.bot.memory.get('STYLE-' + (i + 1) + '-' + sender);
button.data.disabled = ctx.bot.memory.get('DISABLED-' + (i + 1) + '-' + sender);
}
