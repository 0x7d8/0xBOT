...
var cache, description, _a, sender, reciever, balance, otherbalance, message_1, message_2, message_3, missing, message_4, missing, message_5, row1, row2, row3, message;
...
ctx.log(false, "[BTN] TICTACTOE : ".concat(reciever, " : ALREADYLOBBY"));
...
ctx.log(false, "[BTN] TICTACTOE : ".concat(sender, " : ALREADYLOBBY"));
...
ctx.log(false, "[BTN] TICTACTOE : ".concat(reciever, " : ").concat(bet, "\u20AC : NOTENOUGHMONEY"));
...
ctx.log(false, "[BTN] TICTACTOE : ".concat(sender, " : ACCEPT"));
return [2, ctx.interaction.update({ content: '', embeds: [message], components: [row1, row2, row3] })];
}
});
});
}
