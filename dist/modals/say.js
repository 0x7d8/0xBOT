...
var title, content, message;
return __generator(this, function (_a) {
title = ctx.interaction.fields.getTextInputValue('say-title');
content = ctx.interaction.fields.getTextInputValue('say-content');
...
ctx.log(false, "[MOD] SAY : ".concat(title.toUpperCase(), " : ").concat(content.toUpperCase()));
