...
var axios, message_1, result, subreddit, req, random, upvotes, comments, row, message;
...
req = _a.sent();
random = req.data;
upvotes = random[0].data.children[0].data.ups;
comments = random[0].data.children[0].data.num_comments;
if (upvotes === 187)
upvotes = upvotes + ' 🐊';
if (comments === 187)
comments = comments + ' 🐊';
...
.setTitle("<:IMAGE:1024405297579696179> \u00BB ".concat(random[0].data.children[0].data.title.toUpperCase()))
