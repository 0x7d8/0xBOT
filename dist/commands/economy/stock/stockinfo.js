...
var message_1, stock, emoji, stockEmojis, stockList, row, message;
...
if (stock !== 'all')
ctx.log(false, "[CMD] STOCKINFO : ".concat(stock.toUpperCase(), " : ").concat(ctx.client.stocks[stock], "\u20AC"));
else
ctx.log(false, "[CMD] STOCKINFO : ALL : ".concat(ctx.client.stocks.green, "\u20AC : ").concat(ctx.client.stocks.blue, "\u20AC : ").concat(ctx.client.stocks.yellow, "\u20AC : ").concat(ctx.client.stocks.red, "\u20AC : ").concat(ctx.client.stocks.white, "\u20AC : ").concat(ctx.client.stocks.black, "\u20AC"));
