...
var get = function (transactionId) { return __awaiter(void 0, void 0, void 0, function () {
var data;
return __generator(this, function (_a) {
switch (_a.label) {
case 0: return [4, db.query("select * from usertransactions where id = $1;", [transactionId])];
case 1:
data = _a.sent();
if (data.rowCount !== 1)
return [2, 'N-FOUND'];
...
exports.get = get;
var log = function (json) { return __awaiter(void 0, void 0, void 0, function () {
var transactionId;
return __generator(this, function (_a) {
switch (_a.label) {
case 0:
transactionId = utils.randomStr({
length: 20,
numbers: true,
uppercase: true,
lowercase: true,
...
return [4, db.query("insert into usertransactions values ($1, $2, $3, $4, $5, $6, $7, $8, $9)", [
transactionId,
json.sender.id,
json.sender.amount,
json.sender.type,
