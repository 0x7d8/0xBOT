...
export const Option = (props) => {
      ...
      .then((res) => {
        if (res.data.success) {
          ...
          toast({
            ...
            description: <Center>You {calcopt} /meme!</Center>,
            status: "success",
            duration: 1500,
            isClosable: true,
            variant: "subtle",
  ...
  let reformedmeme = 'DISABLED'
  if (settings.meme) { reformedmeme = 'ENABLED' }

  return (
    <Menu>
      <Text color={SwitchIconColor} fontSize="2xl" mt="1rem">MEME COMMAND</Text>
