...
export const Option = (props) => {
      ...
      .then((res) => {
        if (res.data.success) {
          ...
          toast({
            ...
            description: <Center>You {calcopt} Cars!</Center>,
            status: "success",
            duration: 1500,
            isClosable: true,
            variant: "subtle",
  ...
  let reformedcars = 'DISABLED'
  if (settings.cars) { reformedcars = 'ENABLED' }

  return (
    <Menu>
      <Text color={SwitchIconColor} fontSize="2xl" mt="1rem">CAR SYSTEM</Text>
