...
export const Option = (props) => {
      ...
      .then((res) => {
        if (res.data.success) {
          ...
          toast({
            ...
            description: <center>You {calcopt} Items!</center>,
            status: "success",
            duration: 1500,
            isClosable: true,
            variant: "subtle",
  ...
  let reformeditems = 'DISABLED'
  if (settings.items) { reformeditems = 'ENABLED' }

  return (
    <Menu>
      <Text color={SwitchIconColor} fontSize="2xl" mt="1rem">ITEM SYSTEM</Text>
