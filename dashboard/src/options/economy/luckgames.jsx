...
export const Option = (props) => {
      ...
      .then((res) => {
        if (res.data.success) {
          ...
          toast({
            ...
            description: <Center>You {calcopt} Luck Games!</Center>,
            status: "success",
            duration: 1500,
            isClosable: true,
            variant: "subtle",
  ...
  let reformedluckgames = 'DISABLED'
  if (settings.luckgames) { reformedluckgames = 'ENABLED' }

  return (
    <Menu>
      <Text color={SwitchIconColor} fontSize="2xl">LUCK GAMES</Text>
