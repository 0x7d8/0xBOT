...
module.exports = {
    ...
    async execute(interaction, client, lang, vote, bet, sel) {
        ...
        // Send Message
        console.log('[0xBOT] [i] [' + new Date().toLocaleTimeString('en-US', { hour12: false }) + '] [' + interaction.user.id.replace(/\D/g, '') + ' @ ' + interaction.guild.id + '] [BTN] TICTACTOE : ' + sender.toString().replace(/\D/g, '') + ' : DENY')
