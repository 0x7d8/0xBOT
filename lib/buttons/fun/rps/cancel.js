...
var cancel_default = {
  ...
  async execute(ctx, bet) {
    ...
    let message = new import_discord.EmbedBuilder().setColor(3604635).setTitle("<:GAMEPAD:1024395990679167066> \xBB ROCK PAPER SCISSORS").setDescription(`
...
ID: ${transaction.id}` : ""}
    ...
    if (ctx.metadata.language === "de") {
      message = new import_discord.EmbedBuilder().setColor(3604635).setTitle("<:GAMEPAD:1024395990679167066> \xBB SCHERE STEIN PAPIER").setDescription(`
