...
var add_transactions_table_exports = {};
__export(add_transactions_table_exports, {
  default: () => add_transactions_table_default
});
module.exports = __toCommonJS(add_transactions_table_exports);
const migid = 13;
const migna = "ADD TRANSACTIONS TABLE";
var add_transactions_table_default = {
  data: {
    "name": migna
  },
  async migrate(db) {
