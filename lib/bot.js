...
"name": 'EVENTS',
"events": true,
"files": (0, getAllFiles_1.getAllFilesFilter)('./events', '.js')
},
{
"name": 'COMMANDS',
"events": false,
"files": (0, getAllFiles_1.getAllFilesFilter)('./commands', '.js')
},
{
"name": 'BUTTONS',
"events": false,
"files": (0, getAllFiles_1.getAllFilesFilter)('./buttons', '.js')
},
{
"name": 'MODALS',
"events": false,
"files": (0, getAllFiles_1.getAllFilesFilter)('./modals', '.js')
}
];
if (_config_1.default.client.quickload)
login(client, (0, getAllFiles_1.getAllFilesFilter)('./commands', '.js'));
